 ...
 */
export const handleCreateAnalysisRequest = async (request: RequestWithAuth<{ image?: string, imageUrl?: string, requestId?: string }>) => {
 ...
 */
export const handleCreateEnhanceRequest = async (request: RequestWithAuth<{ prompt: string, requestId?: string }>) => {
    const uid = request.auth?.uid;
    if (!uid) { throw new HttpsError('unauthenticated', "User must be authenticated"); }
 ...
 */
export const handleTransformPrompt = async (request: RequestWithAuth<{ prompt: string, styleName: string, intensity: string, instructions?: string }>) => {
 ...
 */
export const handleTransformImage = async (request: RequestWithAuth<{ imageUrl: string, styleName: string, instructions: string, intensity: string, requestId?: string }>) => {
