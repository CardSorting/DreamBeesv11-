...
export class EndpointHealthMonitor {
    ...
    constructor(loadBalancer: any, options: { checkIntervalMs?: number; healthTimeout?: number } = {}) {
     ...
     */
    async checkEndpoint(endpointKey: string): Promise<HealthCheckResult> {
     ...
     */
    getLastChecks(): Record<string, HealthCheckResult> {
...
let healthMonitorInstance: EndpointHealthMonitor | null = null;

export const createHealthMonitor = (loadBalancer: any, options: any = {}): EndpointHealthMonitor => {
...
export const getHealthMonitor = (): EndpointHealthMonitor | null => healthMonitorInstance;
