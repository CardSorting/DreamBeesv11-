...
export interface TcgItem extends MockupItem { }
...
export interface ReskinItem extends DollItem {
    formatSpec: string;
}
...
export const TCG_PRESETS: MockupPreset[] = [
    {
        id: 'gaming_mat',
        label: 'Gaming Mat',
...
export const TCG_ITEMS: TcgItem[] = [
    {
        id: 'tcg_pokemon',
...
export const DOLL_ITEMS: DollItem[] = [
    {
        id: 'doll_mold_1',
        label: 'Basic Mold A',
        moldPath: 'doll1.png',
...
export const DOLL_PRESETS: MockupPreset[] = [
    {
        id: 'doll_studio',
        label: 'Studio Finish',
...
export const RESKIN_ITEMS: ReskinItem[] = [
    {
        id: 'reskin_credit_card',
        label: 'Credit Card',
        moldPath: 'creditcard.png',
...
export const RESKIN_PRESETS: MockupPreset[] = [
    {
        id: 'reskin_studio',
