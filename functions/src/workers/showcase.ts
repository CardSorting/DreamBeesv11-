 ...
 */
async function analyzeImage(imageBuffer: Buffer, mimeType: string = "image/png"): Promise<any> {
 ...
 */
export const processShowcaseTask = async (req: { data: any }): Promise<void> => {
    ...
    let existingDocSnapshot: any = null;
