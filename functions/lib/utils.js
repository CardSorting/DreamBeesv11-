...
export async function retryOperation(operation, options = {}) {
    ...
    while (attempt <= retries) {
        try {
            ...
            // If not transient (and strict checking is desired), we could rethrow here.
            // For robust refunds, we might retry almost everything except obvious logic errors (which valid code shouldn't have).
