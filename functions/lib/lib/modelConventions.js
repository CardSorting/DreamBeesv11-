 ...
 */
export function getModelDefaultSteps(modelId) {
    const config = MODEL_GENERATION_PARAMS[modelId];
 ...
 */
export function getModelGenerationConfig(modelId) {
    const config = MODEL_GENERATION_PARAMS[modelId];
    return config || null;
}
/**
...
export function getModelConfig(modelId) {
    return MODEL_GENERATION_PARAMS[modelId];
}
// ==============================================================================
 ...
 */
export function getPrimaryModelId(modelId) {
 ...
 */
export function modelSupportsHighQuality(modelId) {
 ...
 */
export function modelRequiresSequentialGeneration(modelId) {
 ...
 */
export function migrateModelId(oldId) {
    const migrations = {
