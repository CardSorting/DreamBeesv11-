        ...
        if (event.type === 'checkout.session.completed') {
            ...
            await db.runTransaction(async (t) => {
                ...
                if (mode === 'subscription') {
                    ...
                    const creditResult = await Wallet.credit(userId, 500, requestId, { type: 'subscription_activation', stripeSessionId: session.id }, 'zaps', t);
                    ...
                    if (zapsToAdd > 0) {
                        await Wallet.credit(userId, zapsToAdd, requestId, { type: 'purchase', currency: 'zaps', amount: amount }, 'zaps', t);
            ...
            if (invoice.billing_reason === 'subscription_cycle') {
                await db.runTransaction(async (t) => {
                    ...
                    if (!userSnapshot.empty) {
                        ...
                        const creditResult = await Wallet.credit(userId, 500, requestId, { type: 'subscription_cycle', invoiceId: invoice.id }, 'zaps', t);
                        if (!creditResult.idempotent) {
...
//# sourceMappingURL=stripeHandler.js.map