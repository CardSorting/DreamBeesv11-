    ...
    return (
        <div className="model-picker-page fade-in">
            ...
            <style>{`
                 ...
                 .empty-state button, .use-style-btn { border: none; min-height: 46px; padding: 0 16px; border-radius: 16px; background: linear-gradient(135deg, var(--color-accent), var(--color-dream-purple)); color: white; font-weight: 950; cursor: pointer; box-shadow: 0 18px 36px rgba(139, 92, 246, 0.22); transition: all 0.22s cubic-bezier(0.4, 0, 0.2, 1); }
                 .use-style-btn:hover { filter: brightness(1.15); transform: scale(1.015); box-shadow: 0 20px 40px rgba(139, 92, 246, 0.32); }
                 ...
                 .style-card { border-radius: 24px; overflow: hidden; border: 1px solid rgba(255,255,255,0.08); background: rgba(255,255,255,0.025); cursor: pointer; transition: all 0.28s cubic-bezier(0.4, 0, 0.2, 1); display: flex; flex-direction: column; min-height: 100%; position: relative; }
                 .style-card:hover { transform: translateY(-5px); border-color: rgba(139, 92, 246, 0.45); background: rgba(255,255,255,0.045); box-shadow: 0 20px 42px rgba(0,0,0,0.4), 0 0 20px rgba(139, 92, 246, 0.12); }
                 .style-card.selected { border-color: var(--color-accent); box-shadow: 0 0 0 1px var(--color-accent), 0 22px 44px rgba(139, 92, 246, 0.16); }
                 .style-visual { position: relative; aspect-ratio: 16 / 10; overflow: hidden; background: #18181b; }
                 .style-visual img { width: 100%; height: 100%; object-fit: cover; display: block; transition: transform 0.75s cubic-bezier(0.4, 0, 0.2, 1); }
                 .style-card:hover .style-visual img { transform: scale(1.06); }
                 ...
                 .badge { display: inline-flex; align-items: center; gap: 5px; padding: 5px 9px; border-radius: 999px; background: rgba(0,0,0,0.65); color: white; border: 1px solid rgba(255,255,255,0.13); backdrop-filter: blur(12px); font-size: 0.62rem; font-weight: 950; text-transform: uppercase; letter-spacing: 0.08em; }
                 .badge.selected-badge { background: var(--color-accent); border-color: transparent; }
                 .badge.recommended-badge { color: var(--color-soft-gold); border-color: rgba(251, 191, 36, 0.28); }
                 .badge.cost-badge { background: rgba(0,0,0,0.65); color: var(--color-zinc-300); border-color: rgba(255,255,255,0.08); }
                 .badge.cost-badge.free-badge { background: rgba(16, 185, 129, 0.2); border-color: rgba(16, 185, 129, 0.45); color: #10b981; }
