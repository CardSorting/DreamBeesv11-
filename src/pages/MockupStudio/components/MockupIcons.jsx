...
export const Icons = {
  ...
  StickerPack: (props) => (
    <svg className={props.className || "ms-icon-md"} {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <rect x="4" y="4" width="10" height="10" rx="2" strokeWidth={1.5} />
      <rect x="8" y="8" width="10" height="10" rx="2" strokeWidth={1.5} opacity="0.6" />
      <rect x="12" y="12" width="8" height="8" rx="2" strokeWidth={1.5} opacity="0.3" />
    </svg>
  ),
  // Tote
  Tote: (props) => (
